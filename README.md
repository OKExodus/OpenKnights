...
fully offline edition. The game server runs inside the app, so everything works in Airplane Mode: no account, no
internet connection and no root.
...
The patcher contains no game files. Everything it builds comes from the copy you supply.

## License

OpenKnights is free software under the [GNU General Public License v3.0](LICENSE).

OpenKnights is an unofficial fan preservation project. It is not affiliated with or endorsed by the developers or
publishers of Pocket Knights. Pocket Knights, its logo and its artwork belong to their respective owners.
